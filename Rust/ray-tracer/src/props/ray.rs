...
impl Ray {
    ...
    pub fn create_prime(x: u32, y: u32, scene: &Scene) -> Ray {
        ...
        let image_plane_x = (((x as f64 * 0.5) / scene.width  as f64) * 2.0 - 1.0) * aspect_ratio;
        let image_plane_y = ((y as f64 * 0.5) / scene.height as f64) * 2.0;

        Ray {
            origin:    Vector3::new(0.0, 0.0, 0.0),
            // Normalizing the vector ([1, 1, 1] unit vector).
            // z: -1 is because the plane faces the camera.
